...
**⚠️ CRITICAL**: Migrations are **embedded** in the application binary at compile time and run automatically on startup. Follow this EXACT workflow for migrations.
...
**Step 2: Generate Schema & Rebuild**

**Option A: With Diesel CLI Installed Locally**
```bash
# Load database URL from .env.dev
source ../.env.dev
...
# Option 2: Regenerate from database (requires database running)
source ../.env.dev
diesel print-schema > src/schema.rs
cargo fmt
```
